...
const projects = [
    {
        ...
        description: "A cross-platform booking system for salons that streamlines appointment scheduling, service management, staff availability, and customer notifications.",
        tech: ["React", "Node.js", "PostgreSQL", "Tailwind"],
    },
    {
        id: 2,
        title: "P2B Lending Platform",
        ...
        description: "A secure lending platform connecting private lenders and businesses, featuring loan tracking, approval workflows, and financial dashboards.",
    ...
    },
    {
        ...
        description: "A centralized platform for managing employee or student training programs, tracking progress, and performance evaluations.",
    ...
    },
    {
        ...
        description: "A digital system for managing veterinary records, patient history, and scheduling for efficient clinic operations.",
    ...
    },
    {
        ...
        video: "https://assets.mixkit.co/videos/preview/mixkit-abstract-technology-white-network-connection-2738-large.mp4",
        description: "A mental health support platform that connects patients with providers and offers digital assistance tools.",
        tech: ["Next.js", "OpenAI API", "Stripe", "MongoDB"],
    },
    {
        id: 6,
        title: "AI Water Delivery",
        category: "Mobile Application",
        image: "https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
        video: "https://assets.mixkit.co/videos/preview/mixkit-abstract-technology-white-network-connection-2738-large.mp4",
        description: "An intelligent delivery management app that automates scheduling and optimizes routes for water distribution.",
        tech: ["Next.js", "OpenAI API", "Stripe", "MongoDB"],
    },
    {
        id: 7,
        ...
        image: "https://images.unsplash.com/photo-1620712943543-bcc4688e7485?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
        video: "https://assets.mixkit.co/videos/preview/mixkit-abstract-technology-white-network-connection-2738-large.mp4",
        description: "A browser-based point-of-sale system for handling transactions, managing products, and generating real-time reports.",
        tech: ["Next.js", "OpenAI API", "Stripe", "MongoDB"],
    },
    {
        id: 8,
        ...
        image: "https://images.unsplash.com/photo-1620712943543-bcc4688e7485?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
        video: "https://assets.mixkit.co/videos/preview/mixkit-abstract-technology-white-network-connection-2738-large.mp4",
        description: "A flexible reservation platform for managing bookings, schedules, and availability for service businesses.",
        tech: ["Next.js", "OpenAI API", "Stripe", "MongoDB"],
    },
    {
        id: 9,
        title: "IoT Building Management",
        category: "Web Application",
        image: "https://images.unsplash.com/photo-1620712943543-bcc4688e7485?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
        video: "https://assets.mixkit.co/videos/preview/mixkit-abstract-technology-white-network-connection-2738-large.mp4",
        description: "An IoT-integrated platform for monitoring and controlling building utilities through real-time dashboards.",
        tech: ["Next.js", "OpenAI API", "Stripe", "MongoDB"],
    },
    {
        id: 10,
        title: "Municipal Records System",
        category: "Web Application",
        image: "https://images.unsplash.com/photo-1620712943543-bcc4688e7485?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
        video: "https://assets.mixkit.co/videos/preview/mixkit-abstract-technology-white-network-connection-2738-large.mp4",
        description: "A digital records management system for local government civil registry offices, organizing vital records.",
        tech: ["Next.js", "OpenAI API", "Stripe", "MongoDB"],
    },
    {
        id: 11,
        ...
        image: "https://images.unsplash.com/photo-1620712943543-bcc4688e7485?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
        video: "https://assets.mixkit.co/videos/preview/mixkit-abstract-technology-white-network-connection-2738-large.mp4",
        description: "An integrated system connecting POS operations with inventory tracking and manufacturing workflows.",
        tech: ["Next.js", "OpenAI API", "Stripe", "MongoDB"],
    },
    {
        id: 12,
        ...
        image: "https://images.unsplash.com/photo-1460925895917-afdab827c52f?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
        video: "https://assets.mixkit.co/videos/preview/mixkit-abstract-technology-white-network-connection-2738-large.mp4",
        description: "A mobile app for tracking income, expenses, savings, and budgets with clear financial insights.",
        tech: ["Next.js", "OpenAI API", "Stripe", "MongoDB"],
    },
];
